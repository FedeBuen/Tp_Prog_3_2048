	...
	public ColorPalette(String design) {
		...
		case "GREEN" -> {
	           cp = new HashMap<String, Color>();
	            cp.put("", new Color(46, 27, 91)); // Color predeterminado
	            cp.put("2", new Color(51, 74, 228)); // Amarillo claro
	            cp.put("4", new Color(210, 59, 225)); // Amarillo
	            cp.put("8", new Color(126, 58, 194)); // Verde claro
	            cp.put("16", new Color(24, 128, 106)); // Verde
	            cp.put("32", new Color(160, 81, 188)); // Verde azulado claro
	            cp.put("64", new Color(133, 31, 235)); // Verde azulado
	            cp.put("128", new Color(71, 235, 151)); // Verde azulado oscuro
	            cp.put("256", new Color(245, 49, 160)); // Verde azul oscuro
